...
Contributors: a3rev, nguyencongtuan, a3rev Software
...
* WPEC Grid View always activates the Grid View Feature in WP eCommerce.
...
* Adds Product Card (Grid View) product image Scaling to the WP eCommerce plugin.
...
Want to add a new language to WooCommerce Dynamic Gallery! You can contribute via [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/wp-e-commerce-grid-view)
...
* Feature - Added full Masonry fluid grid
* Feature - Added support for grid view with product categories shortcode
* Feature - Auto Product Card image scaling
...
= 1.0.7 =
Upgrade your plugin now for full compatibility with WordPress Version 4.3 and WP e-Commerce Version 3.9.5
